...
[![Bootstrap 5](https://img.shields.io/badge/Bootstrap%205-7952B3?logo=bootstrap&logoColor=white&style=flat-square)](https://getbootstrap.com/docs/5.0/)
...
1. GitHub Repository: [ bootstrap-auth-homepage Repo](https://github.com/aswinsivadas-tech/bootstrap-auth-homepage)
---
## 📂 Installation & Setup

1. Clone the repository:
   ```bash
   git clone https://github.com/aswinsivadas-tech/bootstrap-auth-homepage.git
